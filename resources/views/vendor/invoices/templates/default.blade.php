...
<body>
    ...
    <p>
        ...
        <a href="{{ route('product-or-service-request.index') }}">Back</a>

        <button onclick="printDiv('rec')">Print</button>
    ...
    <script>
        function printDiv(id) {
            ...
            popupWindow.document.write('<link rel="stylesheet" type="text/css" href="{{ asset('css/app.css') }}">');
