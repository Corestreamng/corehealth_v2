...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1">Aged Receivables Report</h4>
            <p class="text-muted mb-0">Outstanding amounts owed by patients and HMOs</p>
        </div>
        <div>
            ...
            <a href="{{ route('accounting.reports.aged-receivables', ['export' => 'pdf', 'as_of_date' => $asOfDate->format('Y-m-d')]) }}" class="btn btn-danger">
    ...
    <div class="card card-modern mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('accounting.reports.aged-receivables') }}">
                <div class="row">
                    <div class="col-md-4">
    ...
    <div class="card card-modern">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="mdi mdi-table mr-2"></i>Receivables Detail</h5>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                @if(isset($item['customer_type']))
                                    <br><small class="text-muted">{{ ucfirst($item['customer_type']) }}</small>
                                @endif
                            </td>
                        ...
                        <tr>
                            <td colspan="8" class="text-center text-muted py-4">
                                ...
                                <p class="mb-0 mt-2">No outstanding receivables found</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
