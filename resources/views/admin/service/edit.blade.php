                        ...
                        <div class="col-md-10">
                            <select name="procedure_category_id" id="procedure_category_id" class="form-control">
                                ...
                                @foreach($procedureCategories as $procCat)
                                    <option value="{{ $procCat->id }}"
                                        {{ old('procedure_category_id', $procedure->procedure_category_id ?? '') == $procCat->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="procedure_code" class="form-control" name="procedure_code"
                                value="{{ old('procedure_code', $procedure->code ?? '') }}" placeholder="e.g., LAP-CHOLE-001">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div class="custom-control custom-switch mt-2">
                                <input type="checkbox" class="custom-control-input" id="is_surgical" name="is_surgical" value="1"
                                    {{ old('is_surgical', $procedure->is_surgical ?? false) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-10">
                            <div class="input-group" style="max-width: 200px;">
                                <input type="number" id="estimated_duration_minutes" class="form-control"
                                    ...
                                    value="{{ old('estimated_duration_minutes', $procedure->estimated_duration_minutes ?? '') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea id="procedure_description" class="form-control" name="procedure_description"
                                rows="3" placeholder="Procedure description, indications, or notes...">{{ old('procedure_description', $procedure->description ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
