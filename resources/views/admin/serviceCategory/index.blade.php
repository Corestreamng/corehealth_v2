...
@section('subpage_name', 'Service Category List')
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="service-cat" class="table table-sm table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>SN</th>
                                    <th>Category</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="deleteProductCategory">Delete Service Category</h4>
    ...
    <script>
        $(function() {
            ...
            $('#service-cat').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('services-category-list') }}",
                    "type": "GET"
                },
                "columns": [{
                        data: "DT_RowIndex",
