...
@section('subpage_name', 'Edit Ward')
    ...
    <div class="col-12">
        <div class="card-modern">
            <div class="card-header">
                <h3 class="card-title">Edit Ward: {{ $ward->name }}</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('wards.update', $ward->id) }}" class="form-horizontal">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" value="{{ old('name', $ward->name) }}"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror"
                                    id="code" name="code" value="{{ old('code', $ward->code) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2 @error('type') is-invalid @enderror"
                                    ...
                                    @foreach($wardTypes as $value => $label)
                                        <option value="{{ $value }}" {{ old('type', $ward->type) == $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('capacity') is-invalid @enderror"
                                    id="capacity" name="capacity" value="{{ old('capacity', $ward->capacity) }}"
                                    min="0" placeholder="e.g., 20">
                                @error('capacity')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                                <small class="form-text text-muted">
                                    Current beds: {{ $ward->beds()->count() }}
                                </small>
                                <small class="form-text text-muted">Missing beds will be auto-created with names like: Bed 1 - Ward Name</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control @error('bed_price') is-invalid @enderror"
                                    id="bed_price" name="bed_price" value="{{ old('bed_price', $ward->bed_price) }}"
                                    min="0" placeholder="e.g., 15000">
                                @error('bed_price')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                                <small class="form-text text-muted">Updating this will update all beds in this ward.</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nurse_station') is-invalid @enderror"
                                    id="nurse_station" name="nurse_station" value="{{ old('nurse_station', $ward->nurse_station) }}"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('contact_extension') is-invalid @enderror"
                                    id="contact_extension" name="contact_extension" value="{{ old('contact_extension', $ward->contact_extension) }}"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.1" class="form-control @error('nurse_patient_ratio') is-invalid @enderror"
                                    id="nurse_patient_ratio" name="nurse_patient_ratio" value="{{ old('nurse_patient_ratio', $ward->nurse_patient_ratio) }}"
                                    min="0" max="1" placeholder="e.g., 0.25">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-switch mt-2">
                                    <input type="checkbox" class="custom-control-input" id="is_active"
                                        name="is_active" value="1" {{ old('is_active', $ward->is_active) ? 'checked' : '' }}>
                    ...
                    <!-- Ward Statistics -->
                    <div class="card-modern bg-light mt-4">
                        <div class="card-header">
                            <h5 class="mb-0"><i class="mdi mdi-chart-bar"></i> Ward Statistics</h5>
                        </div>
                        <div class="card-body">
                            <div class="row text-center">
                                <div class="col-md-3">
                                    <h4 class="text-primary">{{ $ward->beds()->count() }}</h4>
                                    <small class="text-muted">Total Beds</small>
                                </div>
                                <div class="col-md-3">
                                    <h4 class="text-success">{{ $ward->beds()->where('bed_status', 'available')->count() }}</h4>
                                    <small class="text-muted">Available</small>
                                </div>
                                <div class="col-md-3">
                                    <h4 class="text-danger">{{ $ward->beds()->where('bed_status', 'occupied')->count() }}</h4>
                                    <small class="text-muted">Occupied</small>
                                </div>
                                <div class="col-md-3">
                                    <h4 class="text-warning">{{ $ward->beds()->where('bed_status', 'maintenance')->count() }}</h4>
