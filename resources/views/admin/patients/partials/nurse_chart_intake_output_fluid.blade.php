<div class="fluid-intake-output-section">
    ...
    <div class="card-modern mb-3">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-3 d-flex align-items-end">
                    <div class="btn-group w-100">
                        <button type="button" class="btn btn-sm btn-outline-primary fluid-date-preset" data-days="0" title="Today">
                            Today
                        </button>
                        <button type="button" class="btn btn-sm btn-outline-primary fluid-date-preset" data-days="7" title="Last 7 days">
                            7D
                        </button>
                        <button type="button" class="btn btn-sm btn-outline-primary fluid-date-preset" data-days="30" title="Last 30 days">
                            30D
                        </button>
                    </div>
                </div>
    ...
    <div class="card-modern mb-3" id="fluid-statistics-card" style="display: none;">
        <div class="card-header bg-light">
        ...
        <div class="card-body">
            <div class="row text-center mb-3">
                <div class="col-md-3">
                    <div class="stat-box">
                        <h3 class="text-primary mb-0" id="fluid-total-intake">0</h3>
                        <small class="text-muted">Total Intake (ml)</small>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-box">
                        <h3 class="text-warning mb-0" id="fluid-total-output">0</h3>
                        <small class="text-muted">Total Output (ml)</small>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-box">
                        <h3 id="fluid-net-balance" class="mb-0">0</h3>
                        <small class="text-muted">Net Balance (ml)</small>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-box">
                        <h3 class="text-info mb-0" id="fluid-record-count">0</h3>
                        <small class="text-muted">Total Records</small>
                    </div>
                </div>
            </div>
            <div class="chart-container" style="position: relative; height: 300px;">
                <canvas id="fluidTrendsChart"></canvas>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        ...
        <div class="btn-group">
            <button class="btn btn-outline-secondary btn-sm" id="exportFluidPdfBtn" title="Export to PDF">
