                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline mt-2">
                                <input class="form-check-input" type="checkbox" id="is_family_principal" name="is_family_principal" value="1" onchange="togglePrincipalSelect()" {{ old('is_family_principal', $patient->is_family_principal) ? 'checked' : '' }}>
                            ...
                            <div class="input-group">
                                ...
                                <select name="principal_id" id="principal_id" class="form-control select2">
                                    ...
                                    @foreach($family_principals ?? [] as $principal)
                                        <option value="{{ $principal->id }}" {{ old('principal_id', $patient->principal_id) == $principal->id ? 'selected' : '' }}>
