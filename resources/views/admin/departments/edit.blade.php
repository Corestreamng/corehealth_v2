...
@section('subpage_name', 'Edit Department')
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
            <div class="card-modern">
                <div class="card-header-modern d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="mb-1 font-weight-bold text-dark">Edit Department</h2>
                    ...
                    <form action="{{ route('departments.update', $department) }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control form-control-modern" name="name" value="{{ old('name', $department->name) }}" placeholder="e.g. Nursing Department" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label-modern">Code</label>
                                <input type="text" class="form-control form-control-modern" name="code" value="{{ old('code', $department->code) }}" placeholder="e.g. NURS" maxlength="20">
                        ...
                        <div class="row g-3 mt-3">
                            <div class="col-12">
                                ...
                                <textarea class="form-control form-control-modern" name="description" rows="3" placeholder="Brief description of the department...">{{ old('description', $department->description) }}</textarea>
                            </div>
                        </div>
