    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs service-tabs mb-3" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="presc-history-tab" data-bs-toggle="tab" data-bs-target="#presc-history" type="button" role="tab">
                    <i class="fa fa-history"></i> Drug History
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="presc-new-tab" data-bs-toggle="tab" data-bs-target="#presc-new" type="button" role="tab">
