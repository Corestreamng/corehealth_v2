    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs service-tabs mb-3" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="imaging-history-tab" data-bs-toggle="tab" data-bs-target="#imaging-history" type="button" role="tab">
                    <i class="fa fa-history"></i> Imaging History
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="imaging-new-tab" data-bs-toggle="tab" data-bs-target="#imaging-new" type="button" role="tab">
