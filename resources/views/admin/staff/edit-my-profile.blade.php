            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <h4>Active Image</h4>
                        <img src="{!! asset('storage/image/user/' . $user->filename) !!}" valign="middle" width="150px" height="120px" />
                        <br>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label class="control-label" for="id">User Category (<small>Contact admin if this info is incorrect</small>): <span
                                class="text-danger">*</span></label>
                        <div class="">
                            <input type="text" value="{{ Auth::user()->category->name }}" disabled class="form-control">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label class="control-label" for="title">Email (<small>Contact admin if you wish to change this</small>):</label>
                        <div class="">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="password" class="control-label">Password ( <small>Leave blank if you don not wish to change password</small> )</label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="password" class="control-label">Confirm Password (<small>Leave blank if you don not wish to change password</small>)</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="float-left">
                                <a href="{{ route('home') }}" class="pull-right btn btn-danger"><i
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="float-right">
                                <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure you wish to apply the changes above to you profile?')"><i class="fa fa-save"></i> Save</button>
                            </div>
                        </div>
                    </div>
                </div>
