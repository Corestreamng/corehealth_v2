...
<div class="row g-4 mb-4">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card-modern border-0 shadow-sm h-100" style="border-radius: 12px; background: linear-gradient(135deg, #f7971e 0%, #ffd200 100%);">
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card-modern border-0 shadow-sm h-100" style="border-radius: 12px; background: linear-gradient(135deg, #56ab2f 0%, #a8e063 100%);">
            <div class="card-body text-white">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card-modern border-0 shadow-sm h-100" style="border-radius: 12px; background: linear-gradient(135deg, #dd5e89 0%, #f7bb97 100%);">
            <div class="card-body text-white">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
    ...
    <div class="col-xl-3 col-lg-6">
        <div class="card-modern border-0 shadow-sm h-100" style="border-radius: 12px; background: linear-gradient(135deg, #eb3349 0%, #f45c43 100%);">
            <div class="card-body text-white">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
