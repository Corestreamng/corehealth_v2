<div class="row">
    ...
    <div class="col-sm-6 stretch-card grid-margin">
        <div class="card">
            <div class="card-body">
                ...
                <span class="text-muted font-13">Done today</span>
                <a href="#">
                    <br><br><button type="button" class="btn btn-info mt-2 mt-sm-0 btn-icon-text">
                        <i class="mdi mdi-plus-circle"></i> Manage Procedure Queue </button>
                </a>
            </div>
        </div>
    </div>
    <div class="col-sm-6 stretch-card grid-margin">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="card-title"> Consultations <small class="d-block text-muted">Manage In-queue</small>
                    </div>
                    <div class="d-flex text-muted font-20">
                        <i class="mdi mdi-help-circle-outline ml-2 mouse-pointer"></i>
                    </div>
                ...
                <a href="{{route('encounters.index')}}">
                    <br><br><button type="button" class="btn btn-secondary mt-2 mt-sm-0 btn-icon-text">
                        <i class="mdi mdi-plus-circle"></i> Manage Queue </button>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-6 stretch-card grid-margin">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div class="card-title"> Calender <small class="d-block text-muted">Register and manage appointments</small>
                    </div>
                    <div class="d-flex text-muted font-20">
                        <i class="mdi mdi-help-circle-outline ml-2 mouse-pointer"></i>
                    </div>
                ...
                <a href="#">
                    <br><br><button type="button" class="btn btn-danger mt-2 mt-sm-0 btn-icon-text">
