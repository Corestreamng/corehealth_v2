...
<script src="{{ versioned_asset('js/billing-core.js') }}"></script>
<script src="{{ versioned_asset('js/billing-payments.js') }}"></script>
<script src="{{ versioned_asset('js/billing-hmo.js') }}"></script>
{{-- Payment Scripts --}}
