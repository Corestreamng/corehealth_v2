    ...
    <table style="width: 70%; margin-bottom: 24px;">
        <tbody>
            @if(empty($income_by_scheme))
                <tr><td colspan="2" style="text-align: center; color: var(--muted);">No income data found</td></tr>
            @else
                ...
                <tr style="background: #fafafa;">
                    ...
                    <td class="text-right" style="font-weight: bold;">₦{{ number_format($total_goods_used, 2) }}</td>
                </tr>
            @endif
        </tbody>
    </table>
