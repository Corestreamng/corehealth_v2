...
<script src="{{ versioned_asset('js/lab-core.js') }}"></script>
<script src="{{ versioned_asset('js/lab-results.js') }}"></script>
<script src="{{ versioned_asset('js/lab-reports.js') }}"></script>
