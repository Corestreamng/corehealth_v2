...
<style>
    ...
    .floating-approval-btn:hover {
        transform: scale(1.1);
        box-shadow: 0 6px 20px rgba(111, 66, 193, 0.6);
    }

    .floating-approval-btn .badge {
        position: absolute;
        top: -5px;
        right: -5px;
        background: #dc3545;
...
function confirmApproveLabResult() {
    ...
    $.ajax({
        url: `/lab-workbench/approval/${currentApprovalId}/approve`,
        type: 'POST',
...
function confirmReverseLabApproval() {
    ...
    $.ajax({
        url: `/lab-workbench/approval/${currentReverseId}/reverse`,
        type: 'POST',
        data: { _token: '{{ csrf_token() }}' },
        success: function(response) {
