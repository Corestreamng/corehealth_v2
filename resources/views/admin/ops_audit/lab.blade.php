...
@section('title', 'Ops Audit — Laboratory')

@section('ops_audit_content')
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <h5 class="font-weight-bold mb-0"><i class="mdi mdi-flask-empty text-primary me-1"></i> Laboratory Audit</h5>
        <small class="text-muted">All Lab Requests, Billed Tests, Cashbook</small>
    </div>
...
{{-- Tabs --}}
<ul class="nav nav-tabs ops-tabs mb-0" id="labTabs" role="tablist">
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" id="tab-bills" data-bs-toggle="tab" href="#pane-bills" role="tab">
            <i class="mdi mdi-receipt me-1"></i> Billed Tests
        </a>
    </li>
    <li class="nav-item">
