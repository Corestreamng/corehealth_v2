...
window.BILLING_KIT_CONFIG = {
    ...
    searchServicesRoute: wbRoute('nursing-workbench.search-services', '/nursing-workbench/search-services'),
    searchProductsRoute: wbRoute('nursing-workbench.search-products', '/nursing-workbench/search-products'),
...
// Nurse Medication & Intake-Output Chart Route Templates
var medicationChartIndexRoute = wbUrl('patients/:patient/nurse-chart/medication');
var medicationChartScheduleRoute = wbUrl('patients/nurse-chart/medication/schedule');
var medicationChartAdministerRoute = wbUrl('patients/nurse-chart/medication/administer');
var medicationChartDiscontinueRoute = wbUrl('patients/nurse-chart/medication/discontinue');
var medicationChartResumeRoute = wbUrl('patients/nurse-chart/medication/resume');
var medicationChartDeleteRoute = wbUrl('patients/nurse-chart/medication/delete');
var medicationChartEditRoute = wbUrl('patients/nurse-chart/medication/edit');
var medicationChartRemoveScheduleRoute = wbUrl('patients/nurse-chart/medication/remove-schedule');
var medicationChartCalendarRoute = wbUrl('patients/:patient/nurse-chart/medication/calendar/:medication/:start_date');
var medicationChartPrescribedRoute = wbUrl('patients/:patient/prescribed-drugs');
var medicationChartDismissRoute = wbUrl('patients/:patient/dismiss-prescription');
var medicationChartAdministerDirectRoute = wbUrl('patients/:patient/nurse-chart/medication/administer-direct');
var medicationChartDirectCalendarRoute = wbUrl('patients/:patient/nurse-chart/medication/direct-calendar');
var medicationChartOverviewRoute = wbUrl('patients/:patient/nurse-chart/medication/overview');

var intakeOutputChartIndexRoute = wbUrl('patients/:patient/nurse-chart/intake-output');
var intakeOutputChartLogsRoute = wbUrl('patients/:patient/nurse-chart/intake-output/logs/:period');
var intakeOutputChartStartRoute = wbUrl('patients/nurse-chart/intake-output/start');
var intakeOutputChartEndRoute = wbUrl('patients/nurse-chart/intake-output/end');
var intakeOutputChartRecordRoute = wbUrl('patients/nurse-chart/intake-output/record');
var intakeOutputChartDeleteRecordRoute = wbUrl('patients/nurse-chart/intake-output/record/:record');
...
function loadQueueData(filter) {
    ...
    switch(filter) {
        case 'admitted':
            ...
            break;
        case 'vitals':
            url = wbRoute('nursing-workbench.vitals-queue', '/nursing-workbench/vitals-queue');
            handler = displayVitalsQueue;
            break;
        case 'bed-requests':
            url = wbRoute('nursing-workbench.bed-requests-queue', '/nursing-workbench/bed-requests-queue');
            handler = displayBedRequestsQueue;
            break;
        case 'discharge-requests':
            url = wbRoute('nursing-workbench.discharge-queue', '/nursing-workbench/discharge-queue');
            handler = displayDischargeRequestsQueue;
            break;
        case 'medication-due':
            url = wbRoute('nursing-workbench.medication-due', '/nursing-workbench/medication-due');
            handler = displayMedicationDueQueue;
            break;
        case 'emergency':
            url = wbRoute('emergency.queue', '/emergency/queue');
...
function displayVitalsQueue(patients) {
    ...
    if (!vitalsClinicsLoaded) {
        $.get(wbRoute('nursing-workbench.clinics', '/nursing-workbench/clinics'), function(data) {
    ...
    function renderVitalsQueueFull() {
        ...
        $('#vitals-clinic-filter').on('change', function() {
            ...
            $.get(wbRoute('nursing-workbench.vitals-queue', '/nursing-workbench/vitals-queue'), { clinic_id: vitalsClinicFilter }, function(data) {
...
function loadConsultingQueue() {
    $.get(wbRoute('nursing-workbench.consulting-queue', '/nursing-workbench/consulting-queue'), { clinic_id: vitalsClinicFilter }, function(data) {
...
function openTransferWardModal(admissionId, patientName) {
    ...
    $.get(wbRoute('nursing-workbench.ward-dashboard.available-beds', '/nursing-workbench/ward-dashboard/available-beds'), function(beds) {
...
function loadQueueCounts() {
    $.get(wbRoute('nursing-workbench.queue-counts', '/nursing-workbench/queue-counts'), function(counts) {
