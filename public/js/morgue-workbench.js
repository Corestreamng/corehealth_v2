    $(document).ready(function() {
        ...
        $.extend(window.patientFormConfig, {
            submitUrl: wbRoute('morgue.admit', '/morgue/admit'),
        ...
        function loadData() {
            $.get(wbRoute('morgue.queue', '/morgue/queue'), function(response) {
        ...
        function loadServices(patientId, targetSelect) {
            ...
            $.get(wbRoute('morgue.services', '/morgue/services'), { patient_id: patientId }, function(services) {
        ...
        $('#btn-save-admission').click(function() {
            ...
            $.post(wbRoute('morgue.admit', '/morgue/admit'), data, function(res) {
                if (res.success) {
        ...
        $('#btn-save-service').click(function() {
            ...
            $.post(wbRoute('morgue.add-service', '/morgue/add-service'), data, function(res) {
                if (res.success) {
                    toastr.success(res.message);
        ...
        $('#btn-confirm-release').click(function() {
            ...
            $.post(wbRoute('morgue.release', '/morgue/release'), data, function(res) {
                if (res.success) {
                    toastr.success(res.message);
...
(function() {
    ...
    function loadReports() {
        ...
        $.get(wbRoute('morgue.reports', '/morgue/reports'), { date_from: from, date_to: to })
            .done(function(res) {
                /* KPI cards */
