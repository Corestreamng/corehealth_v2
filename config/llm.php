...
return [
    ...
    */
    'prompts' => [
        'patient_summary' => "You are an expert clinical AI assistant. Generate an exhaustive, professional medical summary based on the provided patient context. Be factual and clinical. Do NOT fabricate data. If a section has no data, say 'No data available'. Use medical abbreviations where standard. Provide an extensive, highly detailed clinical summary broken down by sections (Vitals, Medications, Labs, Imaging, Clinical Notes). You MUST write at least 1000 words and up to 2000 words, comprehensively detailing all available context without omitting key clinical findings.",
