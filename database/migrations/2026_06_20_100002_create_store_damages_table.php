...
class CreateStoreDamagesTable extends Migration
{
    public function up()
    {
        Schema::create('store_damages', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('unit_cost', 10, 2)->comment('Cost per unit at time of damage');
    ...
    {
        Schema::dropIfExists('store_damages');
    }
}
