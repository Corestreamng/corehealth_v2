          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Enter the base URL or IP address of your hospital\'s '
                  'CoreHealth system to access your health records.',
                  style: TextStyle(
                    fontSize: 15,
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Hospital Server Address',
                  ...
                  validator: (v) {
                    if (v == null || v.trim().isEmpty) {
                      return 'Please enter the hospital server address';
                    }
                    return null;
                  },
                ),
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Ask your hospital reception for the server address.',
                        style: TextStyle(
                          fontSize: 12,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _exampleRow('Local:', '192.168.1.100:8000'),
                      const SizedBox(height: 6),
                      _exampleRow('Domain:', 'hospital.corehealth.ng'),
                      const SizedBox(height: 6),
                      _exampleRow('HTTPS:', 'https://emr.myhospital.com'),
                    ],
                  ),
                ),
              ],
